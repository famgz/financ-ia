...
export default function LastTransactions({ lastTransactions }: Props) {
  return (
    <Card className="flex flex-col">
      ...
      <ScrollArea className="h-[200px] flex-auto rounded-md">
          ...
          {lastTransactions.map((transaction) => (
            ...
            >
              <div className="flex gap-4">
                {/* icon */}
                <div className="flex-center size-12 gap-2 rounded-lg bg-muted/80">
                  <Image
                    src={
                      TRANSACTION_PAYMENT_METHOD_ICONS[
              ...
              {/* amount */}
              <div
                className={cn("font-bold", getAmountColor(transaction.type))}
              >
